define({
  "app": {
    "title": "Vidéorama de cartes",
    "errors": {
      "noMaps": "Ce groupe ne contient aucune carte web publique à afficher.",
      "noGroup": "Groupe introuvable",
      "createGroup": "Impossible de créer un groupe",
